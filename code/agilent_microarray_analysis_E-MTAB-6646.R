...
# 3. Define sample metadata (targets)
# 4. Create design matrix and contrasts
# 5. Import raw Agilent .txt files
# 6. Remove control probes
# 7. Background correction and quantile normalization (with optional batch correction)
# 8. Quality control plots
# 9. Filter low-expressed probes (group-aware)
# 10. Collapse duplicate probes
# 11. Fit linear model (limma)
# 12. Extract differential expression results
# 13. Export results to CSV
# 14. Generate volcano plots with top 20 gene labels
